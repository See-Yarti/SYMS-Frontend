...
import { Plus, Pencil, Trash2, RefreshCw, Search, MoreVertical } from 'lucide-react';
                    ...
                    <tbody className="bg-white divide-y divide-gray-100">
                        {filteredRows.map((t, idx) => (
                            ...
                            >
                                ...
                                <td className="px-6 py-4 text-sm text-gray-700 max-w-[420px] truncate" title={t.description || ''}>
                            ...
                            <tr>
                                <td colSpan={6} className="px-6 py-16 text-center text-muted-foreground text-sm">
                                    {searchQuery ? (
                                        ...
                                        <span>No taxes found. Click <b>Add New Tax</b> to get started.</span>
                                    ) : (
                        ...
                        {taxesIsError && (
                            <tr>
                                <td colSpan={6} className="px-6 py-16 text-center text-destructive text-sm">
