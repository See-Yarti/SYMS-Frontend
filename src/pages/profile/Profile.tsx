        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5">
            ...
            <div className="space-y-2 text-center sm:text-left">
              <h2 className="text-xl sm:text-2xl font-medium">{profileData.name}</h2>
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 sm:gap-3 text-white/80 text-sm">
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs sm:text-sm">Member since {profileData.memberSince}</span>
                </span>
              </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-card rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-border flex items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground truncate">Total Bookings</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-6">
          ...
          <div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border">
            <h3 className="text-base sm:text-lg font-normal text-foreground mb-2 sm:mb-3">Bio</h3>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-normal text-sm sm:text-base text-foreground truncate">Administrator</p>
              </div>
          ...
          <div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-border">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs sm:text-sm text-muted-foreground">Last Login</span>
                <span className="text-xs sm:text-sm text-foreground font-normal">2 hours ago</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs sm:text-sm text-muted-foreground">Department</span>
                <span className="text-xs sm:text-sm text-foreground font-normal">Operations</span>
              </div>
            </div>
          </div>
        </div>
