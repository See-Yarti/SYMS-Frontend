          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start sm:justify-between gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              ...
              <div className="text-center sm:text-left">
                <h2 className="text-xl sm:text-2xl font-medium text-white">{user.name}</h2>
          ...
          <div className="w-full">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 bg-[#FFB58424] border border-[#FF802EBF] p-2 sm:p-2 rounded-xl">
              <div className="p-2 sm:p-4">
                <p className="text-xs mt-2 sm:mt-4 text-muted-foreground">Member Since</p>
              ...
              <div className="p-2 sm:p-4">
                <p className="text-xs mt-2 sm:mt-4 text-muted-foreground">Last Login</p>
                <div className="flex items-center gap-1.5 sm:gap-2 mb-1 sm:mb-2">
                  <Clock className="w-3 h-3 sm:w-4 sm:h-4 text-muted-foreground" />
                  <span className="font-normal text-xs sm:text-sm truncate mt-1 text-foreground">2 hours ago</span>
                </div>
              </div>
              <div className="p-2 sm:p-4">
                <p className="text-xs mt-2 sm:mt-4 text-muted-foreground">Account Status</p>
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-green-500"></span>
                  <span className="font-normal text-xs sm:text-sm mt-1 text-green-600">Active</span>
                </div>
              </div>
              <div className="p-2 sm:p-4">
                <p className="text-xs mt-2 sm:mt-4 text-muted-foreground">Verification</p>
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <CheckCircle2 className="w-3 h-3 sm:w-4 sm:h-4 text-[#155DFC]" />
                  <span className="font-normal text-xs sm:text-sm mt-1 text-[#1447E6]">Verified</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-muted-foreground text-xs sm:text-sm font-normal">Bio</FormLabel>
                  <FormControl>
                    <Textarea
      ...
      <div className="bg-[#FEF2F2] dark:bg-red-950/20 rounded-2xl p-4 sm:p-6 border border-[#FFC9C9] dark:border-red-900/40">
        ...
        <div className="bg-white dark:bg-card rounded-xl p-4 sm:p-5 border border-[#FFC9C9]">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h4 className="font-normal text-sm sm:text-base text-foreground">Deactivate Account</h4>
