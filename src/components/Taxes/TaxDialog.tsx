...
export default function TaxDialog({
  ...
  const [taxType, setTaxType] = React.useState<'PERCENTAGE' | 'FIXED'>(
    initialValues?.taxType ?? 'PERCENTAGE',
  );
          ...
          {taxType === 'PERCENTAGE' ? (
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Enter a value between 0 and 100 (exclusive), up to 2 decimals.
                Whole numbers auto-format to <code>.00</code>.
              </p>
            </div>
          ) : (
            <div>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={
              ...
              !title.trim() ||
              (taxType === 'PERCENTAGE'
                ? !isWithinOpenInterval(percentage)
