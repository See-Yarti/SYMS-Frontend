              ...
              <div>
                ...
                <p className="accounting-subtitle">
                  {isAdmin
                    ...
                    : 'View your company financial transactions'}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="accounting-header">
        ...
        <div className="accounting-actions">
          <Button
            ...
            className="accounting-reset-btn"
          >
            <RefreshCw className="mr-2 h-4 w-4" />
            Reset filters
          </Button>
        ...
        <div className="accounting-summary-grid">
          <Card className="accounting-summary-card">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Customer refunds</p>
            </CardContent>
          </Card>
          ...
          <Card className="accounting-summary-card">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Yella commission</p>
            </CardContent>
          </Card>
        ...
        <div className="accounting-results-content">
          {items.length === 0 ? (
            <div className="accounting-empty-state">
              ...
              <h3 className="accounting-empty-title">
                No accounting records found
              </h3>
              <p className="accounting-empty-description">
                Try adjusting your date filters. We will show accounting records
