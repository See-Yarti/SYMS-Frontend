...
const OperatorsPage: React.FC = () => {
  ...
  const { data, isLoading, error, refetch } = useGetAllOperators({
                          ...
                          <Tooltip>
                            <TooltipTrigger>
                              <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F56304] opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F56304]"></span>
                              </span>
                            </TooltipTrigger>
                            <TooltipContent>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {selectedOperator.user.isFirstLogin && (
                      <Badge variant="outline" className="text-[#F56304]">
                        Pending First Login
                      </Badge>
                    )}
                  </div>
              ...
              <div className="grid gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <p>
                      {new Date(
                        selectedOperator.user.lastLoginAt,
                      ).toLocaleString()}
                    </p>
                  </div>
                  <div className="space-y-1">
                    ...
                    <p>
                      {new Date(
                        selectedOperator.user.lastActivityAt,
                      ).toLocaleString()}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <Badge
                          variant={
                            selectedOperator.company.isVerified
                              ? 'default'
                              : 'outline'
                          }
                        >
