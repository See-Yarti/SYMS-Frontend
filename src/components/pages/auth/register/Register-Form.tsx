...
import {
  ...
  useUploadFile,
  useVerifyOtp,
} from '@/hooks/useRegisterOperatorApi';
import {
  Card,
  CardHeader,
  CardContent,
...
const registerSchema = z.object({
  ...
  companyCitiesOfOperation: z
    .array(z.string().min(1, { message: 'City is required' }))
...
const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  useEffect(() => {
    ...
    if (!googleMapsApiKey) {
      console.warn(
        '⚠️ VITE_GOOGLE_MAPS_API_KEY is missing. Check your .env and restart Vite.',
      );
      return;
    }
  ...
  const handleRegister = (data: RegisterFormValues) => {
    ...
    formData.append(
      ...
      data.companyTradeLicenseIssueNumber,
    );
            ...
            if (response.message) {
              ...
              if (response.message.includes('tax number')) {
                const taxNumberInput =
                  document.getElementById('companyTaxNumber');
  ...
  const addCity = () => {
    ...
    setValue('companyCitiesOfOperation', updatedCities, {
      shouldValidate: true,
    });
  };
      ...
      <div className="flex items-center justify-between mb-8 relative">
        ...
        {[1, 2, 3].map((step) => (
          <div key={step} className="flex flex-col items-center z-10">
            ...
            <span
              className={`mt-2 text-sm font-medium ${currentStep >= step ? 'text-primary' : 'text-gray-500'}`}
            >
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.password ? (
                      ...
                      <p className="text-xs text-muted-foreground">
                        Must contain uppercase, number, special character, and
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {/* Apartment/Office */}
                      <div className="space-y-2">
                        <Label htmlFor="companyAddress.apartment">
                          Apartment/Office
                        </Label>
                        <Input
                      ...
                      {/* Additional Info */}
                      <div className="space-y-2 md:col-span-2">
                        <Label htmlFor="companyAddress.additionalInfo">
                          Additional Info
                        </Label>
                        <Input
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {getValues('companyCitiesOfOperation')?.map(
                        (_city, index) => (
                          <div key={index} className="flex gap-2 items-center">
                            ...
                            />
                            {index ===
                            getValues('companyCitiesOfOperation')?.length -
                              1 ? (
                              <Button
                                type="button"
                                variant="outline"
              ...
              <Card className="border border-gray-200 shadow-sm">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <Label className="flex items-center gap-1">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>
                                Upload a clear scan of your tax certificate
                                (PDF, JPG, PNG)
                              </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label
                        htmlFor="companyTradeLicenseExpiryDate"
                        className="flex items-center gap-1"
                      >
                    ...
                    <Label className="flex items-center gap-1">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              Upload a clear scan of your trade license (PDF,
                              JPG, PNG)
                            </p>
                            <p className="text-xs mt-1">Max file size: 5MB</p>
                          </TooltipContent>
                    ...
                    >
                      ...
                      {watch('companyTradeLicenseFile') ? (
                        <div className="flex flex-col items-center gap-2">
                          <FileText className="h-10 w-10 text-primary" />
                          <p className="font-medium truncate max-w-full">
                            {watch('companyTradeLicenseFile').name}
                          </p>
                          <p className="text-sm text-muted-foreground">
                            Click to replace or drag and drop
                          </p>
